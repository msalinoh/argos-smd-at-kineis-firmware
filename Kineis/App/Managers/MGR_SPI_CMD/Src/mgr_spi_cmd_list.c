...
const struct spicmd_desc_t cas_spicmd_list_array[SPICMD_MAX_COUNT] = {
	...
	{ CMD_READ_LPM, CMD_NONE,      				    bMGR_SPI_CMD_READRCONF_cmd},
	{ CMD_WRITE_LPM_REQ, CMD_WRITE_LPM,             bMGR_SPI_CMD_WRITERCONFREQ_cmd},
	{ CMD_WRITE_LPM, CMD_NONE,      			    bMGR_SPI_CMD_WRITERCONF_cmd},
